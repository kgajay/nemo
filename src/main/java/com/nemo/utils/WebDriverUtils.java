...
public class WebDriverUtils {
	 ...
	 * @param waitSec => duration to wait
	 */
	public static void waitForSelectElementValue(final WebElement element, final String value, final int waitSec) {
		new FluentWait<WebElement>(element)
				.withTimeout(waitSec, TimeUnit.SECONDS)
				.pollingEvery(100, TimeUnit.MILLISECONDS)
				.until(new Function<WebElement, Boolean>() {
	 ...
	 */
	public static void waitForWebElementToAppear(final WebDriver driver, final By locator, final int sec) {
